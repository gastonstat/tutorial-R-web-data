...
<<esearch_retmax20, message=FALSE, tidy=FALSE, eval=FALSE>>=
# load XML
library(XML)
...
<<esearch_count103, eval=FALSE, tidy=FALSE>>=
...
<<myesearch, message=FALSE, echo=FALSE>>=
library(XML)
new_search_doc = xmlParse("/Users/Gaston/Documents/Data_Technologies/data/esearch_retmax103.xml")
@
...
<<id_list, message=FALSE, tidy=FALSE>>=
...
<<esummary, message=FALSE, tidy=FALSE, eval=FALSE>>=
...
<<show_esummary, message=FALSE, echo=FALSE>>=
library(XML)
summary_xml = readLines("/Users/Gaston/Documents/Data_Technologies/data/esummary.xml")
for (i in 1:25)
 cat(summary_xml[i], "\n")
@
...
<<myesummary, message=FALSE, echo=FALSE>>=
library(XML)
summary_doc = xmlParse("/Users/Gaston/Documents/Data_Technologies/data/esummary.xml")
@

<<journal_names, tidy=FALSE>>=
# journal names
