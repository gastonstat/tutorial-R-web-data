...
<<parse_get_url_example, eval=FALSE>>=
# load XML
library(XML)
...
<<myparse_get_url_example, echo=FALSE>>=
# load XML
library(XML)

# retrieving the content of the R homepage
rhome = "/Users/Gaston/Documents/Data_Technologies/data/rproject_homepage.html"
Rproj_doc = htmlParse(rhome)
@
